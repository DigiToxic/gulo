...
const Team: NextPage = () => {
  ...
  return (
    <div>
      <div className="bg-[url(https://static.wixstatic.com/media/a67ef4_bead6a0cac024db6a9177a6d4aa2152d~mv2.png)] bg-fixed bg-no-repeat h-full ">
        <Header />
          ...
          >
            ...
            <div className="flex justify-center">
              <p className="text-center w-[900px] max-[1000px]:w-[90%]">
                ...
                45 BTC, making it over 2000 years old.
              </p>
            </div>
          </motion.div>
        </div>
            ...
            <div className="z-30 drop-shadow-lg">
              ...
              >
                <div className="relative h-[650px] max-[600px]:h-[675px] max-[455px]:h-[720px] rounded-3xl">
                  <div className="absolute top-0 right-0 left-0 bottom-0 bg-gradient-to-b from-[#768802] via-[#5D7100] to-[#34593A] z-0 px-60 py-[290px] -mt-4 -ml-[0px] rounded-3xl max-[600px]:px-52">
